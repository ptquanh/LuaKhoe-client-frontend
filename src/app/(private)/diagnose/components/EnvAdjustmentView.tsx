...
export function EnvAdjustmentView({ adjustment }: EnvAdjustmentViewProps) {
  ...
  return (
    <div className="mb-6 overflow-hidden rounded-xl border border-[#E0E0E0] bg-white shadow-sm">
      <div className="flex items-center gap-2 border-b border-[#E0E0E0] bg-[#F8F9FA] px-4 py-3">
      ...
      <div className="p-4">
        ...
        <div className="mb-4 grid grid-cols-2 gap-4 md:grid-cols-4">
          <div className="flex items-center gap-3 rounded-lg bg-[#FFF3E0]/30 p-3">
            ...
            <div>
              <p className="text-[10px] font-[500] text-[#5C5C5C] uppercase">
                Nhiệt độ
              </p>
              <p className="text-[14px] font-[700] text-[#1B1B1B]">
        ...
        <div className="rounded-lg border border-[#E8F5E9] bg-[#F1F8E9]/20 p-3 text-[12px] leading-relaxed text-[#2E7D32]">
          <p className="mb-1 font-[600]">💡 Phân tích của AI:</p>
          Dựa trên điều kiện thời tiết tại địa phương (
          {weather.source === "api" ? "Dữ liệu Open-Meteo" : "Dữ liệu mặc định"}
          ) và thông số thực địa bạn cung cấp, AI đã tự động điều chỉnh độ tin
          cậy để đưa ra kết quả chính xác nhất.
        </div>
      </div>
    </div>
  );
