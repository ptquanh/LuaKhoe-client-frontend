    ...
    <div className="rounded-xl border border-[#E0E0E0] bg-white p-4 shadow-sm">
      <div className="flex gap-3">
        ...
        <div className="flex-1">
          <textarea
            ...
            className="w-full resize-none rounded-lg border border-[#E0E0E0] bg-[#F7F7F7] p-3 text-[14px] text-[#1B1B1B] placeholder-[#9E9E9E] focus:border-[#2F9E44] focus:outline-none focus:ring-1 focus:ring-[#2F9E44]"
            rows={2}
          />
        </div>
      </div>
      ...
      <div className="mt-3 flex items-center justify-between border-t border-[#E0E0E0] pt-3">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg bg-[#2F9E44] px-4 py-2 text-[14px] font-[600] text-white transition-colors hover:bg-[#1F6F2E] disabled:opacity-50 disabled:cursor-not-allowed"
        >
